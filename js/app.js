...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('guideGoAlgorithm')?.addEventListener('click', () => {
        document.querySelector('#helpTabBar .tab-btn[data-tab=algorithm]')?.click();
    });
    document.getElementById('guideGoAiAlgo')?.addEventListener('click', () => {
        document.querySelector('#helpTabBar .tab-btn[data-tab=ai-algo]')?.click();
    });
    document.getElementById('guideGoPlugins')?.addEventListener('click', () => {
        document.querySelector('#helpTabBar .tab-btn[data-tab=plugins]')?.click();
    });
    ...
    if (saved) {
        try {
            ...
            UI.applyGlobalSettings();
            // Restore podium view state before rendering classroom (applyDoorPosition checks this)
